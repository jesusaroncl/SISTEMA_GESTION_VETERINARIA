"""Agregar tabla ubigeo y campos de ubicacion en owners
...
UBIGEOS = [
    ...
    ('050707', 'Ayacucho', 'Parinacochas', 'San Francisco De Rivacayco'),
    ...
    ('130112', 'La Libertad', 'Trujillo', 'Alto Trujillo'),
...
def upgrade():
    ...
    op.bulk_insert(ubigeo_table, [
        {'codigo': c, 'departamento': d, 'provincia': p, 'distrito': di}
        for c, d, p, di in UBIGEOS
    ])

    # Add ubigeo fields to owners table
    op.add_column('owners', sa.Column('ubigeo', sa.String(length=6), nullable=True))
    op.add_column('owners', sa.Column('departamento', sa.String(length=100), nullable=True))
    op.add_column('owners', sa.Column('provincia', sa.String(length=100), nullable=True))
    op.add_column('owners', sa.Column('distrito', sa.String(length=100), nullable=True))


def downgrade():
    op.drop_column('owners', 'distrito')
    op.drop_column('owners', 'provincia')
    op.drop_column('owners', 'departamento')
